...
| **REQ-BLK-1P** | User Request / Structural UI Repair | Structural Layout Repair, Data Hygiene, Image Fallbacks & Cart Reconciliation | RULE-PRD-01..05, RULE-ORD-01..12, RULE-BYR-01..05 | `public_products_catalog`, `public_seller_storefronts`, `drops` | `filterProductionProducts`, `filterProductionStorefronts`, `getFeaturedProducts`, `getAllProducts` | `HomeStorefront.tsx`, `ProductCard.tsx`, `CartDrawer.tsx`, `ShopCategoryDirectory.tsx`, `buyer-catalog.ts` | `cart-ui.test.tsx`, `shop-category-directory.test.tsx`, `home-storefront.test.tsx`, Vitest (457 tests) | `TASK-PHASE1-1P` | **Implemented** |
